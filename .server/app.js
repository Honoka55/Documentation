...
const pagesComponents = {
  ...
  "v-0e8ecea2": vue.defineAsyncComponent(() => Promise.resolve().then(function() {
    return _14_3_0_html$1;
  })),
  "v-1043a741": vue.defineAsyncComponent(() => Promise.resolve().then(function() {
    return _14_3_1_html$1;
  })),
...
const pagesData$1 = {
  ...
  "v-0e8ecea2": () => Promise.resolve().then(function() {
    return _14_3_0_html;
  }).then(({ data: data2 }) => data2),
  "v-1043a741": () => Promise.resolve().then(function() {
    return _14_3_1_html;
  }).then(({ data: data2 }) => data2),
...
var _sfc_main$1n = vue.defineComponent({
...
var _sfc_main$1m = vue.defineComponent(__spreadProps(__spreadValues({}, __default__$1), {
  __ssrInlineRender: true,
  props: {
    title: {
      type: String,
...
var clientAppEnhance0 = defineClientAppEnhance(({ app, router }) => {
  ...
  app.component("OutboundLink", _sfc_main$1l);
...
const routeItems = [
  ...
  ["v-3ecc74e4", "/update/14.1.0.html", "14.1.0 StephanieDola", ["/update/14.1.0", "/update/14.1.0.md"]],
  ...
  ["v-b2a4bc7a", "/update/14.2.0.html", "14.2.0 Jibril", ["/update/14.2.0", "/update/14.2.0.md"]],
  ...
  ["v-0e8ecea2", "/update/14.3.0.html", "14.3.0 Tet", ["/update/14.3.0", "/update/14.3.0.md"]],
  ["v-1043a741", "/update/14.3.1.html", "14.3.1", ["/update/14.3.1", "/update/14.3.1.md"]],
...
function _sfc_ssrRender$15(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><p>\u5728\u4F60\u7684\u4E2A\u4EBA js \u9875\u9762\u6DFB\u52A0\u4EE5\u4E0B\u5185\u5BB9\uFF0C\u7ACB\u523B\u4F7F\u7528\uFF1A</p><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code><span class="token doc-comment comment">/**
...
_sfc_main$1k.ssrRender = _sfc_ssrRender$15;
...
_sfc_main$1j.ssrRender = _sfc_ssrRender$14;
...
_sfc_main$1i.ssrRender = _sfc_ssrRender$13;
...
_sfc_main$1h.ssrRender = _sfc_ssrRender$12;
...
_sfc_main$1g.ssrRender = _sfc_ssrRender$11;
...
_sfc_main$1f.ssrRender = _sfc_ssrRender$10;
...
function _sfc_ssrRender$$(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<p>\u4FDD\u7559\u4E86\u6709\u5173 InPageEdit \u7684\u4E00\u4E9B\u63A5\u53E3\uFF0C\u4F8B\u5982</p><ul><li>Type: {Object}</li><li>Return: <ul><li><code>aboutUrl</code> \u5173\u4E8E&amp;\u5E2E\u52A9\u7684 URL</li><li><code>analysis</code> \u7EDF\u8BA1\u4FE1\u606F\u7684\u6570\u636E\u4E0A\u62A5\u63A5\u53E3</li><li><code>analysisUrl</code> \u7EDF\u8BA1\u4FE1\u606F\u5C55\u793A\u9875\u9762\u7684 URL</li><li><code>updatelogsUrl</code> \u66F4\u65B0\u65E5\u5FD7\u7684 URL</li></ul></li></ul><h2 id="inpageedit-articlelink-element" tabindex="-1"><a class="header-anchor" href="#inpageedit-articlelink-element" aria-hidden="true">#</a> <code>InPageEdit.articleLink([element])</code></h2><p>\u2026\u2026</p><h2 id="inpageedit-preference" tabindex="-1"><a class="header-anchor" href="#inpageedit-preference" aria-hidden="true">#</a> <code>InPageEdit.preference</code></h2><h3 id="inpageedit-preference-default" tabindex="-1"><a class="header-anchor" href="#inpageedit-preference-default" aria-hidden="true">#</a> <code>InPageEdit.preference.default</code></h3><p>\u4FDD\u5B58\u9884\u8BBE\u7684\u53C2\u6570\u8BBE\u7F6E</p><ul><li>Type: [Array]</li><li>Return:</li></ul><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code><span class="token punctuation">{</span>
...
_sfc_main$1e.ssrRender = _sfc_ssrRender$$;
...
_sfc_main$1d.ssrRender = _sfc_ssrRender$_;
...
function _sfc_ssrRender$Z(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1 id="inpageedit-\u540D\u8BCD\u8868" tabindex="-1"><a class="header-anchor" href="#inpageedit-\u540D\u8BCD\u8868" aria-hidden="true">#</a> InPageEdit \u540D\u8BCD\u8868</h1><table><thead><tr><th style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u4E2D\u6587</th><th style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u82F1\u6587</th><th style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u5907\u6CE8</th></tr></thead><tbody><tr><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u63A5\u53E3</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">API</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}"></td></tr><tr><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u529F\u80FD</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">features</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}"></td></tr><tr><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u94A9\u5B50</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">Hook</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}"></td></tr><tr><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u8BED\u8A00\u5305</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">language pack</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}"></td></tr><tr><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u6A21\u5757</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">module</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}"></td></tr><tr><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u65B9\u6CD5</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">method</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}"></td></tr><tr><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u63D2\u4EF6</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">plugin</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}"></td></tr><tr><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u5FEB\u901F\u7F16\u8F91</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">Quick Edit</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}"></td></tr><tr><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u5FEB\u901F\u91CD\u547D\u540D</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">Quick Rename</td><td style="${serverRenderer.ssrRenderStyle({ "text-align": "left" })}">\u522B\u540D\u5FEB\u901F\u79FB\u52A8 (Quick Move)</td></tr></tbody></table><!--]-->`);
}
_sfc_main$1c.ssrRender = _sfc_ssrRender$Z;
...
_sfc_main$1b.ssrRender = _sfc_ssrRender$Y;
...
function _sfc_ssrRender$X(_ctx, _push, _parent, _attrs) {
  _push(`<div${serverRenderer.ssrRenderAttrs(vue.mergeProps({ class: "language-javascript ext-js line-numbers-mode" }, _attrs))}><pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * \u4ECE\u4E0B\u9762\u7684\u65B9\u6CD5\u4E2D\u4EFB\u9009\u4E00\u4E2A\u5373\u53EF Choose one from the following
 */</span>
<span class="token comment">// 1. jsdelivr</span>
mw<span class="token punctuation">.</span>loader<span class="token punctuation">.</span><span class="token function">load</span><span class="token punctuation">(</span><span class="token string">&#39;https://cdn.jsdelivr.net/npm/mediawiki-inpageedit&#39;</span><span class="token punctuation">)</span>
...
_sfc_main$1a.ssrRender = _sfc_ssrRender$X;
...
_sfc_main$19.ssrRender = _sfc_ssrRender$W;
...
_sfc_main$18.ssrRender = _sfc_ssrRender$V;
...
_sfc_main$17.ssrRender = _sfc_ssrRender$U;
...
function _sfc_ssrRender$T(_ctx, _push, _parent, _attrs) {
  ...
  _push(` \u63D2\u4EF6\u5165\u53E3\u6587\u4EF6\u5730\u5740\u5DF2\u66F4\u6539\uFF0C\u8BF7\u4FEE\u6539\u60A8\u7684\u5F15\u7528\u5730\u5740\u4E3A\uFF1A </li></ul><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * \u4ECE\u4E0B\u9762\u7684\u65B9\u6CD5\u4E2D\u4EFB\u9009\u4E00\u4E2A\u5373\u53EF Choose one from the following
 */</span>
<span class="token comment">// 1. jsdelivr</span>
mw<span class="token punctuation">.</span>loader<span class="token punctuation">.</span><span class="token function">load</span><span class="token punctuation">(</span><span class="token string">&#39;https://cdn.jsdelivr.net/npm/mediawiki-inpageedit&#39;</span><span class="token punctuation">)</span>
<span class="token comment">// 2. unpkg</span>
mw<span class="token punctuation">.</span>loader<span class="token punctuation">.</span><span class="token function">load</span><span class="token punctuation">(</span><span class="token string">&#39;https://unpkg.com/mediawiki-inpageedit&#39;</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><ul><li>`);
  _push(serverRenderer.ssrRenderComponent(_component_status, { status: "new" }, null, _parent));
...
_sfc_main$16.ssrRender = _sfc_ssrRender$T;
...
_sfc_main$15.ssrRender = _sfc_ssrRender$S;
...
function _sfc_ssrRender$R(_ctx, _push, _parent, _attrs) {
  const _component_status = vue.resolveComponent("status");
  const _component_OutboundLink = vue.resolveComponent("OutboundLink");
  _push(`<!--[--><h1 id="_14-1-0-stephaniedola" tabindex="-1"><a class="header-anchor" href="#_14-1-0-stephaniedola" aria-hidden="true">#</a> 14.1.0 <code>StephanieDola</code></h1><p>\u66F4\u65B0\u65E5\u671F\uFF1A2020 \u5E74 9 \u6708 10 \u65E5 20:19:20</p><h2 id="\u672C\u6B21\u66F4\u65B0" tabindex="-1"><a class="header-anchor" href="#\u672C\u6B21\u66F4\u65B0" aria-hidden="true">#</a> \u672C\u6B21\u66F4\u65B0</h2><ul><li>`);
  _push(serverRenderer.ssrRenderComponent(_component_status, { status: "info" }, null, _parent));
...
_sfc_main$14.ssrRender = _sfc_ssrRender$R;
...
_sfc_main$13.ssrRender = _sfc_ssrRender$Q;
...
_sfc_main$12.ssrRender = _sfc_ssrRender$P;
...
_sfc_main$11.ssrRender = _sfc_ssrRender$O;
...
_sfc_main$10.ssrRender = _sfc_ssrRender$N;
...
_sfc_main$$.ssrRender = _sfc_ssrRender$M;
...
_sfc_main$_.ssrRender = _sfc_ssrRender$L;
...
_sfc_main$Z.ssrRender = _sfc_ssrRender$K;
...
_sfc_main$Y.ssrRender = _sfc_ssrRender$J;
...
function _sfc_ssrRender$I(_ctx, _push, _parent, _attrs) {
  const _component_status = vue.resolveComponent("status");
  const _component_issues = vue.resolveComponent("issues");
  _push(`<!--[--><h1 id="_14-2-0-jibril" tabindex="-1"><a class="header-anchor" href="#_14-2-0-jibril" aria-hidden="true">#</a> 14.2.0 <code>Jibril</code></h1><p>\u66F4\u65B0\u65F6\u95F4\uFF1A2021 \u5E74 8 \u6708 22 \u65E5 23:35:05</p><div class="custom-container tip"><p class="custom-container-title">\u63D0\u793A</p><p>\u672C\u6B21\u66F4\u65B0\u6709\u65B0\u589E\u529F\u80FD\uFF0C\u6709\u65B0\u589E API\u3002</p></div><h2 id="\u529F\u80FD\u66F4\u65B0" tabindex="-1"><a class="header-anchor" href="#\u529F\u80FD\u66F4\u65B0" aria-hidden="true">#</a> \u529F\u80FD\u66F4\u65B0</h2><ul><li>`);
  _push(serverRenderer.ssrRenderComponent(_component_status, { status: "new" }, null, _parent));
  _push(` \u65B0\u589E\u201C\u94FE\u5165\u9875\u9762\u201D (close `);
...
_sfc_main$X.ssrRender = _sfc_ssrRender$I;
...
_sfc_main$W.ssrRender = _sfc_ssrRender$H;
...
_sfc_main$V.ssrRender = _sfc_ssrRender$G;
...
_sfc_main$U.ssrRender = _sfc_ssrRender$F;
...
_sfc_main$T.ssrRender = _sfc_ssrRender$E;
...
function _sfc_ssrRender$D(_ctx, _push, _parent, _attrs) {
  const _component_OutboundLink = vue.resolveComponent("OutboundLink");
  const _component_issues = vue.resolveComponent("issues");
  _push(`<!--[--><h1 id="_14-3-0-tet" tabindex="-1"><a class="header-anchor" href="#_14-3-0-tet" aria-hidden="true">#</a> 14.3.0 <code>Tet</code></h1><p>\u66F4\u65B0\u65F6\u95F4\uFF1AWed Mar 16 2022 16:19:31 GMT+0800 (\u4E2D\u56FD\u6807\u51C6\u65F6\u95F4)</p><div class="custom-container tip"><p class="custom-container-title">\u63D0\u793A</p><p>\u672C\u6B21\u66F4\u65B0\u6709\u5C11\u91CF\u529F\u80FD\u53D8\u66F4\uFF0CAPI \u6709\u5411\u524D\u517C\u5BB9\u7684\u53D8\u66F4\u3002</p></div><h2 id="\u529F\u80FD\u66F4\u65B0" tabindex="-1"><a class="header-anchor" href="#\u529F\u80FD\u66F4\u65B0" aria-hidden="true">#</a> \u529F\u80FD\u66F4\u65B0</h2><ul><li><code>loadQuickDiff</code> \u73B0\u5728\u652F\u6301\u5F62\u5982 <code>[[Special:Diff/123/456]]</code> \u7684\u5185\u90E8\u94FE\u63A5 (by <a href="https://github.com/Dragon-Fish" target="_blank" rel="noopener noreferrer">@Dragon-Fish`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a>)</li><li>\u5173\u95ED\u4E86 `);
  _push(serverRenderer.ssrRenderComponent(_component_issues, { id: "137" }, null, _parent));
  _push(` <code>quickEdit</code>\u4EE5\u53CA<code>articleLink</code> \u73B0\u5728\u652F\u6301\u65B0\u589E\u6BB5\u843D (by <a href="https://github.com/bhsd-harry" target="_blank" rel="noopener noreferrer">@bhsd-harry`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a> &amp; <a href="https://github.com/Dragon-Fish" target="_blank" rel="noopener noreferrer">@Dragon-Fish`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a>)</li><li>\u5173\u95ED\u4E86 `);
  _push(serverRenderer.ssrRenderComponent(_component_issues, { id: "145" }, null, _parent));
  _push(` \u53EF\u4EE5\u9009\u62E9\u8DF3\u8FC7\u4FDD\u5B58\u9875\u9762\u524D\u7684\u786E\u8BA4 (by <a href="https://github.com/bhsd-harry" target="_blank" rel="noopener noreferrer">@bhsd-harry`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a>)</li></ul><h2 id="\u6545\u969C\u4FEE\u590D" tabindex="-1"><a class="header-anchor" href="#\u6545\u969C\u4FEE\u590D" aria-hidden="true">#</a> \u6545\u969C\u4FEE\u590D</h2><ul><li>\u4FEE\u6B63\u4E86<code>loadQuickDiff</code>\u7684\u4E00\u4E9B\u884C\u4E3A\uFF0C\u73B0\u5728\u5FEB\u901F\u5DEE\u5F02\u5C06<s>\u5C3D\u91CF</s>\u4E0D\u518D\u9519\u8BEF\u7ED1\u5B9A\u5230\u65E0\u5173\u7684<code>a</code>\u6807\u7B7E\u4E0A (by <a href="https://github.com/Dragon-Fish" target="_blank" rel="noopener noreferrer">@Dragon-Fish`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a>)</li><li>\u4FEE\u590D\u4E86 `);
  _push(serverRenderer.ssrRenderComponent(_component_issues, { id: "127" }, null, _parent));
  _push(`\uFF0C<code>quickRedirect</code> \u5C06\u68C0\u67E5\u53D8\u4F53\u9875\u9762 (by <a href="https://github.com/bhsd-harry" target="_blank" rel="noopener noreferrer">@bhsd-harry`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a>)</li><li>\u4FEE\u590D\u4E86 `);
  _push(serverRenderer.ssrRenderComponent(_component_issues, { id: "161" }, null, _parent));
  _push(`\uFF0C<code>quickRedirect</code> \u65F6\uFF0C\u5982\u679C\u7528\u6237\u672A\u62E5\u6709<code>suppressredirect</code>\u6743\u9650\u65F6\uFF0C\u201C\u4E0D\u7559\u91CD\u5B9A\u5411\u201D\u9009\u9879\u5C06\u4E0D\u518D\u53EF\u4EE5\u52FE\u9009\uFF0C\u907F\u514D\u4EA7\u751F\u8BEF\u5BFC (by <a href="https://github.com/bhsd-harry" target="_blank" rel="noopener noreferrer">@bhsd-harry`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a>)</li><li>\u4FEE\u590D\u4E86 `);
  _push(serverRenderer.ssrRenderComponent(_component_issues, { id: "163" }, null, _parent));
  _push(`\uFF0C\u6587\u7AE0\u5185\u7684\u7F16\u8F91\u94FE\u63A5\u5C06\u6B63\u786E\u7684\u751F\u6210\u5FEB\u901F\u7F16\u8F91\u6309\u94AE (by <a href="https://github.com/bhsd-harry" target="_blank" rel="noopener noreferrer">@bhsd-harry`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a>)</li><li>\u4FEE\u590D\u4E86 `);
  _push(serverRenderer.ssrRenderComponent(_component_issues, { id: "150" }, null, _parent));
  _push(`\uFF0C\u5FEB\u901F\u7F16\u8F91\u542B\u6709\u7279\u6B8A\u7B26\u53F7\u7684\u9875\u9762\u65F6\u4E0D\u4F1A\u518D\u51FA\u73B0\u9519\u8BEF (by <a href="https://github.com/bhsd-harry" target="_blank" rel="noopener noreferrer">@bhsd-harry`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a>)</li><li>\u4FEE\u6B63\u4E86<code>articleLink</code>\u7684\u4E00\u4E9B\u884C\u4E3A\uFF0C\u5728\u6700\u8FD1\u66F4\u6539\u4E2D\u4E0D\u4F1A\u518D\u53CD\u590D\u7ED1\u5B9A (by <a href="https://github.com/Dragon-Fish" target="_blank" rel="noopener noreferrer">@Dragon-Fish`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a>)</li><li>\u4FEE\u590D\u4E86 `);
  _push(serverRenderer.ssrRenderComponent(_component_issues, { id: "177" }, null, _parent));
  _push(`\uFF0C\u7F16\u8F91\u63D0\u793A\u73B0\u5728\u4F1A\u6B63\u786E\u663E\u793A (by <a href="https://github.com/bhsd-harry" target="_blank" rel="noopener noreferrer">@bhsd-harry`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a>)</li></ul><h2 id="\u63D2\u4EF6\u66F4\u65B0" tabindex="-1"><a class="header-anchor" href="#\u63D2\u4EF6\u66F4\u65B0" aria-hidden="true">#</a> \u63D2\u4EF6\u66F4\u65B0</h2><blockquote><p>\u968F\u7740\u8FD9\u4E2A\u6838\u5FC3\u7248\u672C\u7684\u53D1\u5E03\uFF0C\u6211\u4EEC\u540C\u65F6\u53D1\u5E03\u4E86\u51E0\u4E2A\u91CD\u5927\u7684\u63D2\u4EF6\u66F4\u65B0\uFF0C\u501F\u7528\u6B64\u5904\u4E3A\u60A8\u4ECB\u7ECD\u4E00\u4E0B\u5B83\u4EEC\u662F\u5341\u5206\u503C\u5F97\u7684\u3002</p><p>\u2014\u2014\u5168\u65B0 <code>WikiEditor</code> \u73B0\u5DF2\u95EE\u4E16\uFF0C\u5168\u65B0 <code>CodeMirror</code> \u5148\u4EA6\u5DF2\u95EE\u4E16\u3002</p></blockquote><h3 id="\u65B0\u63D2\u4EF6-wikieditor" tabindex="-1"><a class="header-anchor" href="#\u65B0\u63D2\u4EF6-wikieditor" aria-hidden="true">#</a> \u65B0\u63D2\u4EF6 <code>WikiEditor</code></h3><blockquote><p>\u8BA9\u8001\u724C\u7F16\u8F91\u8005\u5F00\u5FC3\u7684\u793C\u7269\uFF0C\u5F00\u4E86\u53C8\u5F00\u3002</p></blockquote><p><strong>\u63D2\u4EF6 ID</strong>\uFF1A<code>wiki-editor.js</code></p><p>WikiEditor\uFF0C\u53C8\u88AB\u79F0\u4E3A 2010 \u7248\u7F16\u8F91\u5668\uFF0C\u662F\u5927\u90E8\u5206 MediaWiki \u539F\u751F\u7684\u7F16\u8F91\u5668\u7EC4\u4EF6\uFF0C\u73B0\u5728\u60A8\u53EF\u4EE5\u901A\u8FC7\u8FD9\u4E2A\u63D2\u4EF6\u5728 InPageEdit \u4E0A\u4F53\u9A8C\u5230\u5B83\uFF01</p><h3 id="\u5168\u65B0\u7684-codemirror" tabindex="-1"><a class="header-anchor" href="#\u5168\u65B0\u7684-codemirror" aria-hidden="true">#</a> \u5168\u65B0\u7684 <code>CodeMirror</code></h3><blockquote><p>\u5F00\u53D1\u8005\u7684\u5927\u4E8B\uFF0C\u5927\u5FEB\u6240\u6709\u4EBA\u5FC3\u7684\u5927\u597D\u4E8B\u3002</p></blockquote><p><strong>\u63D2\u4EF6 ID</strong>\uFF1A<code>code-mirror/script.js</code></p><p>\u6211\u4EEC\u5B8C\u5168\u91CD\u5199\u4E86 CodeMirror\uFF0C\u4F7F\u5176\u5C3D\u53EF\u80FD\u4E0E WikiMedia \u7EF4\u62A4\u7684\u7248\u672C\u4FDD\u6301\u4E00\u81F4\u3002</p><p>\u73B0\u5728\uFF0Cwikitext \u8BED\u6CD5\u9AD8\u4EAE\u66F4\u4F73\u51C6\u786E\u4E14\u5F3A\u5927\u3002</p><p>\u53E6\u5916\u4E00\u4E2A\u597D\u6D88\u606F\uFF0C\u5728\u91C7\u7EB3\u4E86\u6765\u81EA <a href="https://github.com/bhsd-harry" target="_blank" rel="noopener noreferrer">@bhsd-harry`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a> \u7684\u51E0\u4E2A\u7CBE\u5999\u7EDD\u4F26\u7684\u4EE3\u7801\u63D0\u4EA4\u540E\uFF0C\u672C\u63D2\u4EF6\u73B0\u5DF2\u652F\u6301\u7F16\u8F91 Widget \u9875\u9762\u65F6\u5BF9 <code>&lt;style&gt;</code> <code>&lt;script&gt;</code> \u5185\u90E8\u7684\u4EE3\u7801\u8FDB\u884C\u9AD8\u4EAE\uFF01bhsd \u7EF4\u62A4\u7740\u53E6\u4E00\u4E2A\u975E\u5E38\u68D2\u7684\u5C0F\u7F16\u8F91\u5DE5\u5177\u2014\u2014<a href="https://zh.moegirl.org.cn/User:Bhsd/Inspector" target="_blank" rel="noopener noreferrer">Inspector`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a>\u2014\u2014\u60A8\u6CA1\u51C6\u4F1A\u559C\u6B22\u5B83\u3002</p><h2 id="\u529F\u80FD\u79FB\u9664" tabindex="-1"><a class="header-anchor" href="#\u529F\u80FD\u79FB\u9664" aria-hidden="true">#</a> \u529F\u80FD\u79FB\u9664</h2><ul><li>quickEdit \u81EA\u5E26\u7684<code>editTools</code>\u4EE5\u53CA\u5176\u9644\u5C5E\u529F\u80FD<code>findAndReplace</code>\u5DF2\u88AB\u79FB\u9664\uFF0C\u60A8\u53EF\u4EE5\u901A\u8FC7\u5F00\u542F<code>wiki-editor</code>\u63D2\u4EF6\u6765\u83B7\u5F97\u66F4\u597D\u7684\u7F16\u8F91\u4F53\u9A8C</li></ul><h2 id="\u6280\u672F\u66F4\u65B0" tabindex="-1"><a class="header-anchor" href="#\u6280\u672F\u66F4\u65B0" aria-hidden="true">#</a> \u6280\u672F\u66F4\u65B0</h2><ul><li>\u91CD\u5199\u4E86<code>_dir</code>\u5BFB\u627E CDN \u8DEF\u5F84\u7684\u884C\u4E3A\uFF1A\u8FD9\u4E00\u4E3E\u63AA\u8BE3\u5728\u4E0E jsdelivr \u89E3\u8026\uFF0C\u8FD9\u610F\u5473\u7740\u60A8\u73B0\u5728\u53EF\u4EE5\u8FD9\u6837\u5F15\u5165 InPageEdit\uFF1A <ul><li><code>https://cdn.jsdelivr.net/npm/mediawiki-inpageedit</code></li><li><code>https://unpkg.com/mediawiki-inpageedit</code></li></ul></li><li>\u5C06\u90E8\u5206\u4F9D\u8D56\u9879\u79FB\u52A8\u5230\u4E86 <code>Plugins</code> \u4ED3\u5E93 <ul><li><code>src/ssi-moadl/*</code> \u2192 Plugins: <code>lib/ssi-modal/*</code></li><li><code>src/skin/ipe-default.css</code> \u2192 Plugins: <code>skins/ipe-default.css</code></li></ul></li></ul><!--]-->`);
}
_sfc_main$S.ssrRender = _sfc_ssrRender$D;
const _sfc_setup$S = _sfc_main$S.setup;
_sfc_main$S.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("../pages/update/14.3.0.html.vue");
  return _sfc_setup$S ? _sfc_setup$S(props, ctx) : void 0;
};
var _14_3_0_html$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": _sfc_main$S
});
...
function _sfc_ssrRender$C(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1 id="_14-3-1" tabindex="-1"><a class="header-anchor" href="#_14-3-1" aria-hidden="true">#</a> 14.3.1</h1><p>\u66F4\u65B0\u65F6\u95F4\uFF1A2022\u5E746\u67081\u65E5 GMT+8 12:43</p><div class="custom-container tip"><p class="custom-container-title">\u63D0\u793A</p><p>\u672C\u6B21\u66F4\u65B0\u6709\u5C11\u91CF\u529F\u80FD\u53D8\u66F4\uFF0CAPI \u6CA1\u6709\u53D8\u66F4\u3002</p></div><h2 id="what-s-changed" tabindex="-1"><a class="header-anchor" href="#what-s-changed" aria-hidden="true">#</a> What&#39;s Changed</h2><h3 id="features" tabindex="-1"><a class="header-anchor" href="#features" aria-hidden="true">#</a> Features</h3><ul><li>feat(preference): enable preference dialog when preferences are set in user JS by @bhsd-harry in https://github.com/inpageedit/inpageedit-v2/pull/180</li></ul><h3 id="fixes" tabindex="-1"><a class="header-anchor" href="#fixes" aria-hidden="true">#</a> Fixes</h3><ul><li>fix: #120 by @bhsd-harry in https://github.com/inpageedit/inpageedit-v2/pull/167</li><li>fix: quickDiff.js by @bhsd-harry in https://github.com/inpageedit/inpageedit-v2/pull/186</li><li>fix: notminor edit state by @Dragon-Fish in https://github.com/inpageedit/inpageedit-v2/pull/188</li><li>fix(init): changed init loading order by @leranjun in https://github.com/inpageedit/inpageedit-v2/pull/193</li><li>Update loadStyles.js by @lovelyCARDINAL in https://github.com/inpageedit/inpageedit-v2/pull/198</li><li>fix: do not intercept clicks with modifier keys pressed by @kidonng in https://github.com/inpageedit/inpageedit-v2/pull/200</li></ul><h3 id="housekeeping" tabindex="-1"><a class="header-anchor" href="#housekeeping" aria-hidden="true">#</a> Housekeeping</h3><ul><li>Update README.md by @lovelyCARDINAL in https://github.com/inpageedit/inpageedit-v2/pull/189</li><li>chore: \u{1F5D1}\uFE0F remove unused files by @Dragon-Fish in https://github.com/inpageedit/inpageedit-v2/pull/184</li><li>docs: + contributing guide by @Dragon-Fish in https://github.com/inpageedit/inpageedit-v2/pull/199</li></ul><h2 id="new-contributors" tabindex="-1"><a class="header-anchor" href="#new-contributors" aria-hidden="true">#</a> New Contributors</h2><ul><li>@leranjun made their first contribution in https://github.com/inpageedit/inpageedit-v2/pull/193</li><li>@kidonng made their first contribution in https://github.com/inpageedit/inpageedit-v2/pull/200</li></ul><p><strong>Full Changelog</strong>: https://github.com/inpageedit/inpageedit-v2/compare/14.3.0...14.3.1</p><!--]-->`);
}
_sfc_main$R.ssrRender = _sfc_ssrRender$C;
const _sfc_setup$R = _sfc_main$R.setup;
_sfc_main$R.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("../pages/update/14.3.1.html.vue");
  return _sfc_setup$R ? _sfc_setup$R(props, ctx) : void 0;
};
var _14_3_1_html$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": _sfc_main$R
});
...
_sfc_main$Q.ssrRender = _sfc_ssrRender$B;
...
_sfc_main$P.ssrRender = _sfc_ssrRender$A;
...
_sfc_main$O.ssrRender = _sfc_ssrRender$z;
...
_sfc_main$N.ssrRender = _sfc_ssrRender$y;
...
_sfc_main$M.ssrRender = _sfc_ssrRender$x;
...
_sfc_main$L.ssrRender = _sfc_ssrRender$w;
...
_sfc_main$K.ssrRender = _sfc_ssrRender$v;
...
function _sfc_ssrRender$u(_ctx, _push, _parent, _attrs) {
  const _component_OutboundLink = vue.resolveComponent("OutboundLink");
  _push(`<!--[--><h1 id="analytics-v5" tabindex="-1"><a class="header-anchor" href="#analytics-v5" aria-hidden="true">#</a> Analytics V5</h1><div class="custom-container tip"><p class="custom-container-title">\u63D0\u793A</p><p>InPageEdit Analysis \u4ECE\u6B64\u7248\u672C\u6B63\u5F0F\u66F4\u540D\u4E3A InPageEdit Analytics</p></div><div class="custom-container warning"><p class="custom-container-title">\u6CE8\u610F</p><p>\u6B64\u7248\u672C\u76F8\u8F83\u4E0A\u4E00\u7248\u672C\uFF0CAPI \u7ED3\u6784\u6709\u7834\u574F\u6027\u53D8\u66F4\uFF0C\u6570\u636E\u7ED3\u6784\u6709\u53D8\u5316\u3002</p><p>V4 \u6570\u636E\u5C06\u88AB\u629B\u5F03\u3002</p></div><h2 id="\u7B80\u4ECB" tabindex="-1"><a class="header-anchor" href="#\u7B80\u4ECB" aria-hidden="true">#</a> \u7B80\u4ECB</h2><p>API \u63A5\u5165\u70B9:</p><ul><li><a href="https://analytics.ipe.wiki/api" target="_blank" rel="noopener noreferrer">https://analytics.ipe.wiki/api`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
...
_sfc_main$J.ssrRender = _sfc_ssrRender$u;
...
_sfc_main$I.ssrRender = _sfc_ssrRender$t;
...
_sfc_main$H.ssrRender = _sfc_ssrRender$s;
...
_sfc_main$G.ssrRender = _sfc_ssrRender$r;
...
_sfc_main$F.ssrRender = _sfc_ssrRender$q;
...
_sfc_main$E.ssrRender = _sfc_ssrRender$p;
...
_sfc_main$D.ssrRender = _sfc_ssrRender$o;
...
_sfc_main$C.ssrRender = _sfc_ssrRender$n;
...
_sfc_main$B.ssrRender = _sfc_ssrRender$m;
...
_sfc_main$A.ssrRender = _sfc_ssrRender$l;
...
function _sfc_ssrRender$k(_ctx, _push, _parent, _attrs) {
  const _component_OutboundLink = vue.resolveComponent("OutboundLink");
  _push(`<!--[--><h1 id="\u504F\u597D\u8BBE\u7F6E-preference" tabindex="-1"><a class="header-anchor" href="#\u504F\u597D\u8BBE\u7F6E-preference" aria-hidden="true">#</a> \u504F\u597D\u8BBE\u7F6E preference</h1><p>\u504F\u597D\u8BBE\u7F6E\u7684\u6253\u5F00\u4F4D\u7F6E\u5728\u5DE5\u5177\u76D2\u4E2D\uFF0C\u53EF\u4EE5\u770B\u5230\u9F7F\u8F6E\u56FE\u6807\uFF0C\u70B9\u51FB\u540E\u53EF\u4EE5\u6253\u5F00 InPageEdit \u504F\u597D\u8BBE\u7F6E\u7A97\u53E3</p><p>\u5728\u8FD9\u4E2A\u5F39\u51FA\u7A97\u53E3\u53EF\u4EE5\uFF1A</p><ul><li>\u4FEE\u6539\u9ED8\u8BA4\u7F16\u8F91\u6458\u8981</li><li>\u4FEE\u6539\u7F16\u8F91\u4E60\u60EF</li><li>\u67E5\u770B\u4E2A\u4EBA\u7684\u4F7F\u7528\u6570\u636E</li><li>\u88C5\u8F7D\u9700\u8981\u7684\u63D2\u4EF6</li><li>\u627E\u5230\u9879\u76EE\u7684 GitHub \u5730\u5740\u534F\u52A9\u5F00\u53D1\u2026\u2026</li></ul><h2 id="\u914D\u7F6E\u9879" tabindex="-1"><a class="header-anchor" href="#\u914D\u7F6E\u9879" aria-hidden="true">#</a> \u914D\u7F6E\u9879</h2><p>\u9664\u4E86\u901A\u8FC7\u504F\u597D\u8BBE\u7F6E\u7A97\u53E3\uFF0C\u60A8\u8FD8\u53EF\u4EE5\u901A\u8FC7\u5728 InPageEdit \u6838\u5FC3\u52A0\u8F7D\u524D\u4FEE\u6539\u5168\u5C40\u5BF9\u8C61\u4E0A\u7684<code>InPageEdit.myPreference</code>\u7684\u503C\u6765\u914D\u7F6E\u504F\u597D\u8BBE\u7F6E\u3002</p><p><strong>\u793A\u4F8B</strong></p><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code><span class="token punctuation">;</span><span class="token punctuation">(</span>window<span class="token punctuation">.</span>InPageEdit <span class="token operator">=</span> window<span class="token punctuation">.</span>InPageEdit <span class="token operator">||</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">.</span>myPreference <span class="token operator">=</span> <span class="token punctuation">{</span>
  editMinor<span class="token operator">:</span> <span class="token boolean">true</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h3 id="inpageedit-core" tabindex="-1"><a class="header-anchor" href="#inpageedit-core" aria-hidden="true">#</a> InPageEdit Core</h3><table><thead><tr><th>\u952E\u540D</th><th>\u7C7B\u578B</th><th>\u9884\u8BBE</th><th>\u8BF4\u660E</th></tr></thead><tbody><tr><td>editMinor</td><td><code>boolean</code></td><td><code>false</code></td><td>\u662F\u5426\u9884\u8BBE\u7F16\u8F91\u4E3A\u5C0F\u7F16\u8F91</td></tr><tr><td>editSummary</td><td><code>string</code></td><td><code>i18n:&lt;preference-summary-default&gt;</code></td><td>\u9884\u8BBE\u7F16\u8F91\u6458\u8981</td></tr><tr><td>lockToolBox</td><td><code>boolean</code></td><td><code>false</code></td><td>\u662F\u5426\u603B\u662F\u81EA\u52A8\u5C55\u5F00\u53F3\u4E0B\u89D2\u5DE5\u5177\u76D2</td></tr><tr><td>redLinkQuickEdit</td><td><code>boolean</code></td><td><code>true</code></td><td>\u662F\u5426\u4E3A\u7EA2\u94FE\u6DFB\u52A0\u5FEB\u901F\u7F16\u8F91\u6309\u94AE</td></tr><tr><td>outSideClose</td><td><code>boolean</code></td><td><code>false</code></td><td>\u80FD\u5426\u901A\u8FC7\u70B9\u51FB\u7F16\u8F91\u5668\u5916\u90E8\u5173\u95ED</td></tr><tr><td>watchList</td><td><code>&#39;nochange&#39; | &#39;preferences&#39; | &#39;watch&#39; | &#39;unwatch&#39;</code></td><td><code>&#39;preferences&#39;</code></td><td>\u5206\u522B\u8868\u793A\uFF1A\u4E0D\u6539\u53D8\u76D1\u89C6\u72B6\u6001\u3001\u6309\u7CFB\u7EDF\u8BBE\u7F6E\u3001\u603B\u662F\u76D1\u89C6\u3001\u4ECE\u4E0D\u76D1\u89C6</td></tr><tr><td>plugins</td><td><code>string[]</code></td><td><code>[&#39;toolbox.js&#39;, &#39;wiki-editor.js&#39;]</code></td><td>\u6B32\u4F7F\u7528\u7684\u63D2\u4EF6\u7684 ID \u5217\u8868\uFF0C\u53EF\u7528\u63D2\u4EF6\u89C1 <a href="https://ipe-plugins.js.org" target="_blank" rel="noopener noreferrer">https://ipe-plugins.js.org`);
  _push(serverRenderer.ssrRenderComponent(_component_OutboundLink, null, null, _parent));
  _push(`</a></td></tr><tr><td>noConfirmEdit</td><td><code>boolean</code></td><td>-</td><td>\u662F\u5426\u8DF3\u8FC7\u70B9\u51FB\u4FDD\u5B58\u65F6\u7684\u786E\u8BA4\u5F39\u7A97</td></tr><tr><td>noRedirectIfConvertedTitleExists</td><td><code>boolean</code></td><td>-</td><td>\u5FEB\u901F\u91CD\u5B9A\u5411\u68C0\u6D4B\u76EE\u6807\u9875\u9762\u662F\u5426\u5B58\u5728\u65F6\u662F\u5426\u68C0\u67E5\u53D8\u4F53\u9875\u9762 (\u7B80\u7E41\u68C0\u6D4B)</td></tr></tbody></table><h3 id="plugin-codemirror" tabindex="-1"><a class="header-anchor" href="#plugin-codemirror" aria-hidden="true">#</a> Plugin - CodeMirror</h3><table><thead><tr><th>\u952E\u540D</th><th>\u7C7B\u578B</th><th>\u9884\u8BBE</th><th>\u8BF4\u660E</th></tr></thead><tbody><tr><td>codeMirrorTheme</td><td><code>string</code></td><td><code>&#39;solarized light&#39;</code></td><td>\u5B9A\u4E49 CodeMirror \u63D2\u4EF6\u6240\u52A0\u8F7D\u7684\u4E3B\u9898</td></tr><tr><td>codeMirrorThemeNoCSS</td><td><code>boolean</code></td><td>-</td><td>\u662F\u5426\u4E0D\u81EA\u52A8\u52A0\u8F7D\u4E3B\u9898\u4EE5\u4FBF\u4F7F\u7528\u81EA\u5B9A\u4E49\u7684\u4E3B\u9898 CSS</td></tr></tbody></table><!--]-->`);
}
_sfc_main$z.ssrRender = _sfc_ssrRender$k;
const _sfc_setup$z = _sfc_main$z.setup;
_sfc_main$z.setup = (props, ctx) => {
...
const _sfc_main$y = {};
function _sfc_ssrRender$j(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1 id="\u5FEB\u901F\u5220\u9664-quick-delete" tabindex="-1"><a class="header-anchor" href="#\u5FEB\u901F\u5220\u9664-quick-delete" aria-hidden="true">#</a> \u5FEB\u901F\u5220\u9664 quick-delete</h1><div class="custom-container tip"><p class="custom-container-title">\u63D0\u793A</p><p>\u6CE8\u610F\uFF1A\u8981\u4F7F\u7528\u672C\u529F\u80FD\uFF0C\u60A8\u9700\u8981<code>delete</code>\u76F8\u5173\u7684\u6743\u9650</p></div><p>\u60A8\u53EF\u4EE5\u5728\u5DE5\u5177\u76D2\u4E2D\u627E\u5230\u5783\u573E\u6876\u56FE\u6807\u7684\u6309\u94AE\uFF0C\u70B9\u51FB\u4EE5\u64CD\u4F5C\u5F53\u524D\u6761\u76EE\u7684\u5FEB\u901F\u5220\u9664\u3002</p><p>\u5FEB\u901F\u5220\u9664\u65F6\u7684\u7406\u7531\u662F\u5FC5\u586B\u7684\uFF0C\u8FD9\u662F\u51FA\u4E8E\u9632\u6B62\u8BEF\u5220\u9664\u7684\u8003\u8651\u3002</p><!--]-->`);
}
_sfc_main$y.ssrRender = _sfc_ssrRender$j;
const _sfc_setup$y = _sfc_main$y.setup;
_sfc_main$y.setup = (props, ctx) => {
...
const _sfc_main$x = {};
function _sfc_ssrRender$i(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1 id="\u5FEB\u901F\u5DEE\u5F02-quick-diff" tabindex="-1"><a class="header-anchor" href="#\u5FEB\u901F\u5DEE\u5F02-quick-diff" aria-hidden="true">#</a> \u5FEB\u901F\u5DEE\u5F02 quick-diff</h1><p>\u5F53\u67E5\u770B\u67D0\u4E2A\u6761\u76EE\u7684\u5386\u53F2\u65F6\u5019\uFF0C\u603B\u662F\u9700\u8981\u67E5\u770B\u4E0A\u4E2A\u7F16\u8F91\u8005\u505A\u4E86\u4E9B\u4EC0\u4E48\uFF0CInPageEdit \u5728\u52A0\u8F7D\u5B8C\u6210\u540E\u4F1A\u5728\u7248\u672C\u5386\u53F2\u9875\u9762\u663E\u793A\u201C\u5FEB\u901F\u5DEE\u5F02\u201D\u6309\u94AE\u3002\u53EF\u4EE5\u76F4\u63A5\u70B9\u51FB\u8FD9\u4E2A\u6309\u94AE\u67E5\u770B\u4E24\u4E2A\u7248\u672C\u7684\u5DEE\u5F02\u3002</p><p>\u4E0E\u539F\u672C\u7684\u201C\u5BF9\u6BD4\u9009\u62E9\u7684\u7248\u672C\u201D\u4E0D\u540C\uFF0C\u201C\u5FEB\u901F\u5DEE\u5F02\u201D\u53EF\u4EE5\u5728\u5F39\u51FA\u7684\u7A97\u53E3\u4E2D\u663E\u793A\u5DEE\u5F02\uFF0C\u5728\u67E5\u770B\u540E\u53EF\u4EE5\u5173\u6389\uFF0C\u5E76\u4E14\u4E0D\u5F71\u54CD\u5F53\u524D\u9875\u9762\u3002</p><!--]-->`);
}
_sfc_main$x.ssrRender = _sfc_ssrRender$i;
const _sfc_setup$x = _sfc_main$x.setup;
_sfc_main$x.setup = (props, ctx) => {
...
const _sfc_main$w = {};
function _sfc_ssrRender$h(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1 id="\u5FEB\u901F\u7F16\u8F91-quick-edit" tabindex="-1"><a class="header-anchor" href="#\u5FEB\u901F\u7F16\u8F91-quick-edit" aria-hidden="true">#</a> \u5FEB\u901F\u7F16\u8F91 quick-edit</h1><p><strong>\u5FEB\u901F\u7F16\u8F91</strong> (quick-edit) \u662F\u6700\u5E38\u7528\u7684\u529F\u80FD\u4E4B\u4E00\uFF0C\u80FD\u8BA9\u60A8\u5728\u4E0D\u6253\u5F00\u65B0\u6807\u7B7E\u9875\u7684\u60C5\u51B5\u4E0B\u7F16\u8F91\u6307\u5B9A\u9875\u9762\u3001\u4ECE\u9875\u9762\u5386\u53F2\u7F16\u8F91\u6216\u8005\u7F16\u8F91\u6307\u5B9A\u9875\u9762\u7684\u6307\u5B9A\u6BB5\u843D\uFF0C\u751A\u81F3\u7F16\u8F91\u5386\u53F2\u9875\u9762\u7684\u6307\u5B9A\u6BB5\u843D\u3002</p><blockquote><p>\u503C\u5F97\u6CE8\u610F\u7684\u662F\uFF0C\u5F53\u4F7F\u7528\u5FEB\u901F\u7F16\u8F91\u529F\u80FD\u7F16\u8F91\u5386\u53F2\u7248\u672C\u65F6\uFF0C\u5728\u53F3\u4E0A\u89D2\u4F1A\u5F39\u51FA\u6A59\u8272\u63D0\u9192\u3002</p></blockquote><h2 id="\u901A\u8FC7\u5DE5\u5177\u76D2\u4F7F\u7528" tabindex="-1"><a class="header-anchor" href="#\u901A\u8FC7\u5DE5\u5177\u76D2\u4F7F\u7528" aria-hidden="true">#</a> \u901A\u8FC7\u5DE5\u5177\u76D2\u4F7F\u7528</h2><p>\u60A8\u53EF\u4EE5\u5728\u5DE5\u5177\u76D2\u4E2D\u627E\u5230\u5C0F\u94C5\u7B14\u56FE\u6807\u7684\u6309\u94AE\uFF0C\u70B9\u51FB\u53EF\u4EE5\u5FEB\u901F\u7F16\u8F91\u5F53\u524D\u6240\u5728\u7684\u6761\u76EE\u3002</p><h2 id="\u901A\u8FC7\u7F16\u8F91\u6BB5\u843D\u65C1\u7684\u94FE\u63A5\u7F16\u8F91\u6BB5\u843D" tabindex="-1"><a class="header-anchor" href="#\u901A\u8FC7\u7F16\u8F91\u6BB5\u843D\u65C1\u7684\u94FE\u63A5\u7F16\u8F91\u6BB5\u843D" aria-hidden="true">#</a> \u901A\u8FC7\u7F16\u8F91\u6BB5\u843D\u65C1\u7684\u94FE\u63A5\u7F16\u8F91\u6BB5\u843D</h2><p>\u5728\u6BB5\u843D\u6807\u9898\u65C1\u8FB9\uFF0C\u4F1A\u591A\u51FA\u6765\u201C\u5FEB\u901F\u7F16\u8F91\u201D\u94FE\u63A5\uFF0C\u53EF\u4EE5\u901A\u8FC7\u8FD9\u4E2A\u94FE\u63A5\u542F\u52A8\u7F16\u8F91\u5668\u5E76\u4E14<strong>\u53EA</strong>\u7F16\u8F91\u8FD9\u4E2A\u6BB5\u843D\u3002</p><h2 id="\u5728\u6D4F\u89C8\u9875\u9762\u5386\u53F2\u8BB0\u5F55\u65F6\u4F7F\u7528" tabindex="-1"><a class="header-anchor" href="#\u5728\u6D4F\u89C8\u9875\u9762\u5386\u53F2\u8BB0\u5F55\u65F6\u4F7F\u7528" aria-hidden="true">#</a> \u5728\u6D4F\u89C8\u9875\u9762\u5386\u53F2\u8BB0\u5F55\u65F6\u4F7F\u7528</h2><p>\u5728\u7248\u672C\u5386\u53F2\u9875\u9762\uFF0C\u53EF\u4EE5\u901A\u8FC7\u70B9\u51FB\u4EFB\u610F\u4E00\u6761\u5386\u53F2\u7F16\u8F91\u540E\u9762\u7684\u201C\u5FEB\u901F\u7F16\u8F91\u201D\u94FE\u63A5\u6765\u7F16\u8F91\u5386\u53F2\u7248\u672C\u3002</p><h2 id="\u5728\u5FEB\u901F\u9875\u9762\u5DEE\u5F02\u65F6\u4F7F\u7528" tabindex="-1"><a class="header-anchor" href="#\u5728\u5FEB\u901F\u9875\u9762\u5DEE\u5F02\u65F6\u4F7F\u7528" aria-hidden="true">#</a> \u5728\u5FEB\u901F\u9875\u9762\u5DEE\u5F02\u65F6\u4F7F\u7528</h2><p>\u6253\u5F00\u5FEB\u901F\u5DEE\u5F02\u540E\uFF0C\u53EF\u4EE5\u5728\u70B9\u51FB\u9876\u90E8\u5DE6\u4FA7\u6216\u8005\u53F3\u4FA7\u7684\u5FEB\u901F\u7F16\u8F91\u7528\u6765\u7F16\u8F91\u6307\u5B9A\u7248\u672C\u3002</p><!--]-->`);
}
_sfc_main$w.ssrRender = _sfc_ssrRender$h;
const _sfc_setup$w = _sfc_main$w.setup;
_sfc_main$w.setup = (props, ctx) => {
...
const _sfc_main$v = {};
function _sfc_ssrRender$g(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1 id="\u5FEB\u901F\u9884\u89C8-quick-preview" tabindex="-1"><a class="header-anchor" href="#\u5FEB\u901F\u9884\u89C8-quick-preview" aria-hidden="true">#</a> \u5FEB\u901F\u9884\u89C8 quick-preview</h1><p>\u5728\u7F16\u8F91\u5B8C\u6210\u540E\uFF0C\u53EF\u4EE5\u70B9\u51FB\u201C\u5FEB\u901F\u7F16\u8F91\u201D\u5F39\u51FA\u7A97\u53E3\u4E2D\u7684\u201C\u663E\u793A\u9884\u89C8\u201D\u6309\u94AE\u3002\u4E0D\u5FC5\u6253\u5F00\u65B0\u7684\u9875\u9762\u67E5\u770B\u7F16\u8F91\u597D\u7684\u7ED3\u679C\uFF0C\u5728\u5F39\u51FA\u7A97\u53E3\u5C31\u53EF\u4EE5\u770B\u5230\uFF0C\u70B9\u51FB\u53F3\u4E0A\u89D2\u5173\u95ED\u540E\uFF0C\u8FD8\u53EF\u4EE5\u7EE7\u7EED\u7F16\u8F91\u3002</p><p>\u4E0D\u8FC7\uFF0C\u5982\u679C\u9700\u8981\u4FDD\u5B58\u66F4\u6539\uFF0C\u4E5F\u5FC5\u987B\u5173\u95ED\u5FEB\u901F\u9884\u89C8\u7A97\u53E3\u3002</p><!--]-->`);
}
_sfc_main$v.ssrRender = _sfc_ssrRender$g;
const _sfc_setup$v = _sfc_main$v.setup;
_sfc_main$v.setup = (props, ctx) => {
...
const _sfc_main$u = {};
function _sfc_ssrRender$f(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1 id="\u5FEB\u901F\u91CD\u5B9A\u5411-quick-redirect" tabindex="-1"><a class="header-anchor" href="#\u5FEB\u901F\u91CD\u5B9A\u5411-quick-redirect" aria-hidden="true">#</a> \u5FEB\u901F\u91CD\u5B9A\u5411 quick-redirect</h1><p>\u60A8\u53EF\u4EE5\u5728\u5DE5\u5177\u76D2\u4E2D\u5206\u522B\u627E\u5230\u5E26\u6709\u51FA\u53E3\u548C\u5165\u53E3\u56FE\u6807\u7684\u4E24\u4E2A\u6309\u94AE\uFF0C\u5B83\u4EEC\u5206\u522B\u4EE3\u8868\u201C\u91CD\u5B9A\u5411\u5230\u201D\u548C\u201C\u91CD\u5B9A\u5411\u81F3\u6B64\u201D\u529F\u80FD\uFF0C\u5728\u5F39\u51FA\u7A97\u53E3\u586B\u5199\u5177\u4F53\u4FE1\u606F\u540E\uFF0C\u70B9\u51FB\u786E\u5B9A\u6309\u94AE\uFF0C\u53EF\u4EE5\u5FEB\u901F\u5B8C\u6210\u91CD\u5B9A\u5411\u64CD\u4F5C\u3002</p><!--]-->`);
}
_sfc_main$u.ssrRender = _sfc_ssrRender$f;
const _sfc_setup$u = _sfc_main$u.setup;
_sfc_main$u.setup = (props, ctx) => {
...
const _sfc_main$t = {};
function _sfc_ssrRender$e(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1 id="\u5FEB\u901F\u91CD\u547D\u540D-quick-rename" tabindex="-1"><a class="header-anchor" href="#\u5FEB\u901F\u91CD\u547D\u540D-quick-rename" aria-hidden="true">#</a> \u5FEB\u901F\u91CD\u547D\u540D quick-rename</h1><p>\u60A8\u53EF\u4EE5\u5728\u5DE5\u5177\u76D2\u4E2D\u627E\u5230\u201C\u8F93\u5165\u5149\u6807\u201D\u56FE\u6807\u7684\u6309\u94AE\uFF0C\u70B9\u51FB\u53EF\u4EE5\u5BF9\u5F53\u524D\u6D4F\u89C8\u7684\u6761\u76EE\u8FDB\u884C\u79FB\u52A8\u3002</p><p>\u5FEB\u901F\u79FB\u52A8\u65F6\uFF0C\u53EF\u4EE5\u9009\u62E9\u540C\u65F6\u79FB\u52A8\u8BA8\u8BBA\u9875\u548C\u5B50\u9875\u9762\uFF0C\u4F46\u662F\u60A8\u6700\u591A\u53EA\u80FD\u591F\u540C\u65F6\u79FB\u52A8 100 \u4E2A\u5B50\u9875\u9762\u3002</p><!--]-->`);
}
_sfc_main$t.ssrRender = _sfc_ssrRender$e;
const _sfc_setup$t = _sfc_main$t.setup;
_sfc_main$t.setup = (props, ctx) => {
...
const _sfc_main$s = {};
function _sfc_ssrRender$d(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1 id="\u5DE5\u5177\u76D2-toolbox" tabindex="-1"><a class="header-anchor" href="#\u5DE5\u5177\u76D2-toolbox" aria-hidden="true">#</a> \u5DE5\u5177\u76D2 toolbox</h1><p>\u770B\u5230\u8FD9\u4E2A\u9875\u9762\uFF0C\u6216\u8BB8\u5DF2\u7ECF\u5728 Wiki \u4E0A\u88C5\u8F7D\u4E86 InPageEdit\u3002\u90A3\u4E48\uFF0C\u53EF\u4EE5\u5728\u53F3\u4E0B\u89D2\u770B\u5230\u4E00\u4E2A\u84DD\u5E95\u767D\u8272\u5341\u5B57\uFF0C\u5C06\u9F20\u6807\u653E\u4E0A\u53BB\u53EF\u4EE5\u5C55\u5F00\u83DC\u5355\uFF0CInPageEdit \u7684\u90E8\u5206\u529F\u80FD\u53EF\u4EE5\u76F4\u63A5\u5728\u8FD9\u91CC\u542F\u52A8\u3002</p><p>\u76EE\u524D\u7248\u672C\u4E2D\uFF0C\u5728\u4E0D\u5B89\u88C5\u5176\u4ED6\u63D2\u4EF6\u7684\u60C5\u51B5\u4E0B\u4F7F\u7528\u4EE5\u4E0B\u529F\u80FD\uFF1A</p><ul><li>\u5FEB\u901F\u7F16\u8F91</li><li>\u5FEB\u901F\u5220\u9664</li><li>\u5FEB\u901F\u91CD\u547D\u540D</li><li>\u504F\u597D\u8BBE\u7F6E\uFF08\u66F4\u6539\u63D2\u4EF6\u8BBE\u7F6E\uFF09</li><li>\u91CD\u5B9A\u5411\uFF08\u5305\u62EC\u201C\u91CD\u5B9A\u5411\u5230\u201D\u548C\u201C\u91CD\u5B9A\u5411\u81F3\u6B64\u201D\uFF09</li></ul><!--]-->`);
}
_sfc_main$s.ssrRender = _sfc_ssrRender$d;
const _sfc_setup$s = _sfc_main$s.setup;
_sfc_main$s.setup = (props, ctx) => {
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><ol start="2"><li>Create <code>MediaWiki:Gadget-InPageEdit.js</code> as:</li></ol><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * \u4ECE\u4E0B\u9762\u7684\u65B9\u6CD5\u4E2D\u4EFB\u9009\u4E00\u4E2A\u5373\u53EF Choose one from the following
 */</span>
<span class="token comment">// 1. jsdelivr</span>
mw<span class="token punctuation">.</span>loader<span class="token punctuation">.</span><span class="token function">load</span><span class="token punctuation">(</span><span class="token string">&#39;https://cdn.jsdelivr.net/npm/mediawiki-inpageedit&#39;</span><span class="token punctuation">)</span>
<span class="token comment">// 2. unpkg</span>
mw<span class="token punctuation">.</span>loader<span class="token punctuation">.</span><span class="token function">load</span><span class="token punctuation">(</span><span class="token string">&#39;https://unpkg.com/mediawiki-inpageedit&#39;</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><ol start="3"><li>Create <code>MediaWiki:Gadget-InPageEdit</code> and write some content like this:</li></ol><div class="language-wiki ext-wiki line-numbers-mode"><pre class="language-wiki"><code><span class="token url">[InPageEdit https://github.com/Dragon-Fish/InPageEdit-v2/]</span> - \u7531\u673A\u667A\u7684\u5C0F\u9C7C\u541B\u5F00\u53D1\uFF0C\u9762\u5411\u719F\u7EC3\u7528\u6237\u7684\u5FEB\u901F\u7EF4\u62A4\u5DE5\u5177\u96C6(\u5C0F\u7F16\u8F91\u3001\u91CD\u5B9A\u5411\u3001\u9875\u9762\u5386\u53F2)
...
_sfc_main$o.ssrRender = _sfc_ssrRender$9;
const _sfc_setup$o = _sfc_main$o.setup;
_sfc_main$o.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
...
_sfc_main$n.ssrRender = _sfc_ssrRender$8;
const _sfc_setup$n = _sfc_main$n.setup;
_sfc_main$n.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
...
_sfc_main$m.ssrRender = _sfc_ssrRender$7;
const _sfc_setup$m = _sfc_main$m.setup;
_sfc_main$m.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
...
_sfc_main$l.ssrRender = _sfc_ssrRender$6;
const _sfc_setup$l = _sfc_main$l.setup;
_sfc_main$l.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
...
_sfc_main$k.ssrRender = _sfc_ssrRender$5;
const _sfc_setup$k = _sfc_main$k.setup;
_sfc_main$k.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
...
_sfc_main$j.ssrRender = _sfc_ssrRender$4;
const _sfc_setup$j = _sfc_main$j.setup;
_sfc_main$j.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
...
_sfc_main$i.ssrRender = _sfc_ssrRender$3;
const _sfc_setup$i = _sfc_main$i.setup;
_sfc_main$i.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
...
const data$A = {
  ...
  "headers": [
    ...
    },
    {
      ...
      "children": [
        {
          "level": 3,
          "title": "\u65B0\u63D2\u4EF6 WikiEditor",
          "slug": "\u65B0\u63D2\u4EF6-wikieditor",
          "children": []
        },
        {
          "level": 3,
          "title": "\u5168\u65B0\u7684 CodeMirror",
          "slug": "\u5168\u65B0\u7684-codemirror",
          "children": []
        }
      ]
  ...
  "filePathRelative": "update/14.3.0.md",
  "git": {
    "updatedTime": 1654059271e3,
    "contributors": []
  }
};
var _14_3_0_html = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  data: data$A
});
const data$z = {
  ...
  "filePathRelative": "update/14.3.1.md",
  "git": {
    "updatedTime": 1654059271e3,
    "contributors": []
  }
};
var _14_3_1_html = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  data: data$z
});
  ...
  "headers": [
    {
      ...
      "children": [
        {
          "level": 3,
          "title": "InPageEdit Core",
          "slug": "inpageedit-core",
          "children": []
        },
        {
          "level": 3,
          "title": "Plugin - CodeMirror",
          "slug": "plugin-codemirror",
          "children": []
        }
      ]
    }
...
var _sfc_main$1 = vue.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      serverRenderer.ssrRenderSlot(_ctx.$slots, "default", {}, () => {
        _push(`issue#${serverRenderer.ssrInterpolate(__props.id)}`);
      }, _push, _parent);
