...
var clientAppEnhance4 = ({ app }) => {
  app.component("ColorPreview", defineAsyncComponent(() => __vitePreload(() => import("./ColorPreview.76a1db8e.js"), true ? [] : void 0))), app.component("infobox", defineAsyncComponent(() => __vitePreload(() => import("./infobox.c35fb7bb.js"), true ? [] : void 0))), app.component("issues", defineAsyncComponent(() => __vitePreload(() => import("./issues.eb3b7b68.js"), true ? [] : void 0))), app.component("status", defineAsyncComponent(() => __vitePreload(() => import("./status.aeca770a.js"), true ? [] : void 0)));
};
